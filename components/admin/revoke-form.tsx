...
import { revokeCertificateAction, type AdminActionState } from '@/app/admin/actions'
...
export function RevokeForm() {
  ...
  return (
    <form action={formAction} className="max-w-md">
      ...
      <label htmlFor="revoke-certId" className="mb-1.5 block text-[15px] font-medium">
        Certificate ID
      </label>
      <input
        id="revoke-certId"
      ...
      <label htmlFor="revoke-reason" className="mb-1.5 block text-[15px] font-medium">
        Reason <span className="font-normal text-[var(--brand-muted)]">(kept on record)</span>
      </label>
      <textarea
        id="revoke-reason"
        name="reason"
      ...
      <p className="mb-4 text-[14px] leading-relaxed text-[var(--brand-muted)]">
        Revocation cannot be undone from here. The public verification page will show the
        certificate as withdrawn, and a replacement can be issued if the learner is still
        eligible.
      </p>
